...
const Custom404 = () => {
    return (
        <div className="min-h-screen bg-gradient-to-b from-blue-50 to-purple-50 flex flex-col items-center justify-center text-center p-4">
            <h1 className="text-4xl font-bold mb-6 text-black">Oops! Page Not Found</h1>
            <p className="text-xl mb-8 text-black">It seems the page you are looking for does not exist.</p>
            <Link href="/" passHref>
